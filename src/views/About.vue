<template>
  ...
  <div class="row g-0">
    ...
    <div class="col-md-8" id="personal" >
      ...
      <div class="col-md-12">
      <div class="card-body" >
        <h2 class="card-title" id="heading">Personal Details</h2>
        <p class="card-text"><ul  style="list-style: none;">
                       <li>Full name: Mogamat Saleem Ariedien</li>
                      <li>
