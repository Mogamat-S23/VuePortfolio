...
export default createStore({
  ...
  },
  {
    name:"Taucia",
    surname:"Jackson",
    about:"Saleem is a Hardworking And Dedicated Individual Who Is Always Willing To Go The Extra Mile. He Understands And Respects Others. He Is Quick Learner, Stays On Track And Completes Projects In A Timely Manner.Your Company Would Be Well Served By Him,",
    title:"Colleague",
...
Resume:[{
    name:"Summery",
    year:"",
    info:"hardwork and deadline-driven Aspiring Web developmer and Designer with 2 years of expeirence of designing developing using tools such as.",
    skills: [
     "Visual Studio Code" ,
     "Visual Studio",
     "CodePen",
